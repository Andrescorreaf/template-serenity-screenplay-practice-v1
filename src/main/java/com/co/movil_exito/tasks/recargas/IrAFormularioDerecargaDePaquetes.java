...
import com.co.movil_exito.tasks.home.direccionarprepagadas;
...
public class recargaExitosaDePaquetes implements Performable {
    public static Performable  clicken() {
        return instrumented(recargaExitosaDePaquetes.class);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(MoveMouse.to(paqutes.BTN_COMPRA_PAQUETE));
        actor.attemptsTo(Click.on(paqutes.BTN_COMPRA_PAQUETE));
        actor.attemptsTo(MoveMouse.to(paqutes.BTN_CONTINUAR_MODAL_SELECT_LINEA));
